...
BOOL CALLBACK MainDlgProc(HWND hDlg, UINT uMsg, WPARAM wParam, LPARAM lParam)
{
	...
	case WM_INITDIALOG:		//ダイアログ初期化
		...
		//背景，軸を表示
		hPict01 = GetDlgItem(hDlg, IDC_PICTBOX1);
		WinInitialize(NULL, hDlg, (HMENU)110, "TEST1", hPict01, WndProc, &Sps.hwnd[0]);
		hPict02 = GetDlgItem(hDlg, IDC_PICTBOX2);
		WinInitialize(NULL, hDlg, (HMENU)110, "TEST2", hPict02, WndProc, &Sps.hwnd[1]);
		return TRUE;
...
UINT WINAPI TFunc(LPVOID thParam)
{
	...
	int width1, width2, hight1, hight2;				//PICTBOXの幅
